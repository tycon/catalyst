...
sig
  ...
  (*
   *  For each hole in the given set of VCs, generate a set of RPreds
   *  that are its potential solutions. Currently, RExprs in generated
   *  RPreds are either U or X. Further, we can only handle unary or
   *  binary relations.
   *)
